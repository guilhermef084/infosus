...
<head>
    ...
    <!-- PHP -->
    <?php include 'processosPHP/processoCadastrarAdministrador.php'; ?>
        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb">
                ...
                <hr>
                 <div class="row">
                    <div class="col-5">
                     <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#exampleModal">Novo Administrador</button>
							  ...
							  <div class="modal-dialog modal-lg" role="document">
								<div class="modal-content">
								  ...
								  <div class="modal-body">
									<form method="post" class="was-validated">
									  <div class="form-group">
                                        <div clas="row">
                                            <label for="nomeHospital" class="col-form-label">Nome Administrador:</label>
								  ...
								  <div class="modal-footer">
									...
									<button type="submit" name="cadastrarAdministrador" class="btn btn-primary" id="cad">Cadastrar</button>
								  </div>
								  </form>
								</div>
							  </div>
                     ...
                     <div class="col-4">
                     <a href="processosPHP/processoRelatorioGeralA.php" target="_blank">
                ...
                <div class="row">
                    <?php include 'processosPHP/processoAdministrador.php'; ?>  
                </div>
                 <!-- MODAL DE LOGOUT -->
