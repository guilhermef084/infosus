...
include 'conexao.php';
    ...
    $query = $con->query("SELECT codHospital, nomeHospital, cepHospital, logradouroHospital, numeroHospital, compHospital, bairroHospital, cidadeHospital, estadoHospital, loginHospital, senhaHospital FROM tbhospital where inativo=1 and codHospital='$idHospital'");
...
//referenciar o DomPDF com namespace
                ...
                $dompdf->load_html('
                        ...
                        <h3 style="text-align: right;">Relatório Individual - Hospital</h3>
