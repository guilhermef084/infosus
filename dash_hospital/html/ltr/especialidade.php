...
<head>
    ...
    <?php        
        require_once("processosPHP/crud/inserirEspecialidade.php");
    ...
    <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full" data-boxed-layout="full">
       ...
       <aside class="left-sidebar" data-sidebarbg="skin5">
        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb">
                ...
                <div class="row justify-content-between">
                    <button type="button" class="mx-3 btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#exampleModal">
                    Nova Especialidade
                    </button>
                          ...
                          <div class="modal-dialog modal-md" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h3 class="modal-title-lg" id="exampleModalLabel">Novo Especialidade</h3>
                              ...
                              <div class="modal-body">
                                <form method="post" class="needs-validation" name="form" enctype="multipart/form-data" novalidate>
                                  <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <label for="validationCustom01" class="col-form-label">Nome da Especialidade:</label>
                                            <input type="text" id="validationCustom01" name="txtNome" class="form-control" required/>
                                            <input type="text" name="codHospitalLogado" class="form-control" value="<?php echo $codHospitalLogado; ?>" required/> 
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <button type="submit"class="btn btn-primary" name="cadastrarEspecialidade">Cadastrar </button>
                                  </div>
                              </form>
                            </div>
		                  </div>
              ...
              <div class="row mt-2">
                   <div class="container card pb-3">
                        <div id="listar">
                            <?php require_once('processosPHP/processaEspecialidade.php'); ?>
                        </div>
                   </div>
               </div>
        </div>
        ...
        <div class="modal fade" id="modalConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Deseja realmente excluir essa especialidade?</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                </div>
    ...
    <!-- scripts de ações -->
     <script>
        $('#tabela_dados tbody td a.excluir').click(function(e){
            ...
            let id_especialidade=$(this).attr("title");
            $("#confirmar").attr("title",id_especialidade)
        });
        $("#confirmar").click(function(){
            let id_especialidade = $("#confirmar").attr("title")
            $.ajax({
                type:"POST",
                data:"idEspecialidade="+ id_especialidade,
                url:"processosPHP/crud/inativarEspecialidade.php",
                async:false
            }).done(function(data){
