...
<head>
    ...
    <title>Especialidades - Inativas</title>
    ...
    <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full" data-boxed-layout="full">
       ...
       <aside class="left-sidebar" data-sidebarbg="skin5">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="text-muted">Especialidades - Inativas</h4>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Especialidades - Inativas</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
              ...
              <div class="row mt-2">
                   <div class="container card pb-3">
                        <div id="listar">
                            <?php require_once('processosPHP/processaEspecialidade_i.php'); ?>
                        </div>
                   </div>
               </div>
        </div>
        ...
        <div class="modal fade" id="modalConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Deseja realmente ativar essa especialidade?</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                </div>
    ...
    <script type="text/javascript">
        ...
        $("#confirmar").click(function(){
            ...
            $.ajax({
                ...
                url:"processosPHP/crud/ativarEspecialidade.php",
                async:false
            }).done(function(data){
                $sucesso = $.parseJSON(data)['sucesso'];
                    if($sucesso){
                        swal({
                            title: "Especialidade ativada com Sucesso!",
                            icon: "success",
                            button: "Fechar"
