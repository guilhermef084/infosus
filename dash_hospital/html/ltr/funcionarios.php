...
<head>
    ...
    <!-- script -->
    <script type="text/javascript" src="../../../arquivos-js-css/assets/libs/lib-custom/js/js-custom/imagepreview.js"></script>
	<script type="text/javascript" src="../../../arquivos-js-css/assets/libs/lib-custom/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="../../../arquivos-js-css/assets/libs/lib-custom/js/js-custom/mascara.min.js"></script>

    <!-- sweaterAlert -->
    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    
    <?php 
        require_once('processosPHP/crud/inserirFuncionario.php');
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="text-muted">Funcionários</h4>
                    </div>
                          ...
                          <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h3 class="modal-title-lg" id="exampleModalLabel">Novo Funcionário</h3>
                                ...
                                <form method="post" class="needs-validation" name="form" enctype="multipart/form-data" novalidate>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6"> 
                                            <label for="validationServer03" class="col-form-label">Tipo de Acesso:</label>
                                            <select class="form-control" name="codTipoAcesso">
                                                <?php require_once("processosPHP/processoSelectTipoAcesso.php"); ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <label for="validationCustom04" class="col-form-label">E-mail:</label>
                                            <input type="email" id="validationCustom04" name="txtEmail" class="form-control" required /> 
                                            <div class="invalid-feedback">
                                                Campo obrigatório*
                                            </div>
                                        </div>
                                         <div class="col-sm-6"> 
                                            ...
                                            <input type="password" id="validationCustom05" name="txtPass" class="form-control" required />
                                            <div class="invalid-feedback">
                                                Campo obrigatório*
                                            </div>
                                        </div>
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <button type="submit"class="btn btn-primary" name="cadastrarFuncionario">Cadastrar </button>
                                  </div>
                              </form>
                            </div>
		                  </div>
              ...
              <div class="row mt-2">
                   <div class="container card pb-3">
                        <div id="listar">
                            <?php require_once('processosPHP/processaFuncionario.php'); ?>
                        </div>
                   </div>
               </div>
        </div>
    ...
    <script>
        $('#tabela_dados tbody td a.excluir').click(function(e){
            ...
            $.ajax({
                ...
                url:"processosPHP/crud/inativarFuncionario.php",
                async:false
            }).done(function(data){
        ...
        $(document).ready(function() {
         $('#tabela_dados').DataTable( {
          "language": {
            ...
            "zeroRecords": "Nenhum registro encotrado,cadastre!",
