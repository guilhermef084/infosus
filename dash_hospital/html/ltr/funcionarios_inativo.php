...
<head>
    ...
    <title>Funcinário - Inativos</title>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="text-muted">Funcionário - Inativos</h4>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Funcionário - Inativos</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
              ...
              <div class="row mt-2">
                   <div class="container card pb-3">
                        <div id="listar">
                            <?php require_once('processosPHP/processaFuncionario_i.php'); ?>
                        </div>
                   </div>
               </div>
        </div>
    ...
    <script>
        $('#tabela_dados tbody td a.excluir').click(function(e){
            ...
            $.ajax({
                ...
                url:"processosPHP/crud/ativarFuncionario.php",
                async:false
            }).done(function(data){
                $sucesso = $.parseJSON(data)['sucesso'];
                if($sucesso){
                    swal({
                        title: "Funcinário ativado com Sucesso!",
                        text: "",
                        icon: "success",
                        button: "Fechar"
