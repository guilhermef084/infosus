...
<body>
    ...
    <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full" data-boxed-layout="full">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header" data-logobg="skin5">
                   ...
                   <div class="navbar-brand">
                        <a href="index.php?location=1" class="logo">
                            <!-- Logo icon -->
                            <b class="logo-icon">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Painel do Hospital</h4>
                    </div>
            ...
            <div class="container-fluid" onLoad="initTimer();">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card">
                            <div class="card-body">
                                <h5>Funcionários cadastrados: <?php require_once("processosPHP/processoCountFuncionarios.php"); ?></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="card">
                            <div class="card-body">
                                <h5>Médicos cadastrados: <?php require_once("processosPHP/processoCountMedico.php"); ?></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="card">
                            <div class="card-body">
                                <h5>Especialidades cadastradas: <?php require_once("processosPHP/processoCountEspecialidade.php"); ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-12 align-self-left">
                                    <h5 class="page-subtitle">
                                        ...
                                        <?php 
                                            ...
                                            echo $dataAtual = date ("d/m/Y");
                                        ?>
                                    </h5>
                                </div>    
                             <?php require_once("processosPHP/processaPlantaoAtual.php"); ?>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- MODAL DE LOGOUT -->
         <div class="modal fade modalLogout" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Deseja realmente sair?</h5>
    ...
    <script>
        function buscarPeriodo() {
            var busca = document.getElementById("buscarPeriodo").checked = true;

            var sectionEspecialidade = document.querySelector("#buscarPorEspecialidade");
            var sectionPeriodo = document.querySelector("#buscarPorData");

            if(busca === true){
                sectionPeriodo.style.display = "block";
                sectionEspecialidade.style.display = "none";
            }

        }
        function buscarEspecialidade() {
            var busca2 = document.getElementById("buscarEspecialidade").checked = true;
            var sectionEspecialidade = document.querySelector("#buscarPorEspecialidade");
            var sectionPeriodo = document.querySelector("#buscarPorData");

            if(busca2 === true){
                sectionEspecialidade.style.display = "block";
                sectionPeriodo.style.display = "none";
            }
            if(busca2 === false){
