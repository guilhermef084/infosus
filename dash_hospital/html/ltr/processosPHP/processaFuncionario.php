      ...
      <table id="tabela_dados" class="table table-striped border border-dark table-hover">
        ...
        <?php while($reg=$query->fetch_array()){ ?>
          <div class="col-sm-4 mb-2 conts">
            <?php createFuncionario($reg['codFuncionario'],$reg['nomeFuncionario'],$reg['sobreNomeFuncionario'],$reg['codTipoAcesso'],$reg['cpfFuncionario'],$reg['fotoFuncionario'],$server,$user,$pass,$bd);?>
          </div>
        <?php 
            }
          } 
