	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
                <form class="form-signin" method="post" action="validaLoginHospital.php">
					...
					<div class="wrap-input100 validate-input" data-validate = "Coloque um nome de usuário">
						<input class="input100" id="inputEmail" type="text" name="txtUsuario" placeholder="Login">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Coloque sua senha">
						<input class="input100" id="inputPassword" type="password" name="txtSenha" placeholder="Senha">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
